...
/**
 * Edita una asignación existente del historial (#14), incluido el cliente.
 * La tarea/bandeja/slot no se editan (vienen del dosímetro).
 */
public class EditarAsignacionRequest {
    ...
    public EditarAsignacionRequest() {
    }
